...
describe('AliasService', () => {
  ...
  describe('getFormattedAddress without options', () => {
    it('when getFormattedAddress is given address that has an alias without options', () => {
      expect(service.getFormattedAddress(mockedAddressWithAlias)).toEqual(mockedAddressAlias)
    })
    it('when getFormattedAddress is given address that has no alias without options', () => {
      expect(service.getFormattedAddress(mockedAddressWithoutAlias)).toEqual(mockedAddressShortened)
    })
  })
  ...
  describe('getFormattedAddress with options', () => {
    it('when getFormattedAddress is given address that has an alias with showAlliasOrFullAddress', () => {
      expect(service.getFormattedAddress(mockedAddressWithAlias, mockedOptions1)).toEqual(mockedAddressAlias)
    })
    it('when getFormattedAddress is given address that has no alias with showAlliasOrFullAddress', () => {
      expect(service.getFormattedAddress(mockedAddressWithoutAlias, mockedOptions1)).toEqual(mockedAddressWithoutAlias)
    })

    it('when getFormattedAddress is given address that has an alias with showFullAddress', () => {
      expect(service.getFormattedAddress(mockedAddressWithAlias, mockedOptions2)).toEqual(mockedAddressWithAlias)
    })
    it('when getFormattedAddress is given address that has no alias with showFullAddress', () => {
      expect(service.getFormattedAddress(mockedAddressWithoutAlias, mockedOptions2)).toEqual(mockedAddressWithoutAlias)
    })
  })
})
