...
export function first<T>(array: T[]) { return isNotEmptyArray(array) ? array[0] : undefined }
export function get<T>(accessor: (_entity: T) => any) { return (entity: T) => entity ? accessor(entity) : undefined }
