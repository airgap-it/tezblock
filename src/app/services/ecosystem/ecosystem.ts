  ...
  ecosystem: EcosystemItem[] = [
    {
      ...
      description: this.translateService.instant(
        'ecosystem-wallets.airgap.description'
      ),
      logo: 'AirGap.svg',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-wallets.airgap.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-wallets.atomic.description'
      ),
      ...
      features: [
        this.translateService.instant('ecosystem-wallets.atomic.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-wallets.atomex.description'
      ),
      logo: 'atomex.png',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-wallets.atomex.features'),
      ],
      downloadLink:
        'https://github.com/atomex-me/atomex.client.wpf/releases/download/v1.0.8/Atomex.Client.msi',
      category: EcosystemCategory.wallet,
    },
    {
      title: this.translateService.instant('ecosystem-wallets.galleon.title'),
      description: this.translateService.instant(
        'ecosystem-wallets.galleon.description'
      ),
      logo: 'galleon.png',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-wallets.galleon.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-wallets.kukai.description'
      ),
      logo: 'kukai.svg',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-wallets.kukai.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-wallets.ledger.description'
      ),
      logo: 'ledger.svg',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-wallets.ledger.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-wallets.simplestaking.description'
      ),
      ...
      features: [
        this.translateService.instant(
          'ecosystem-wallets.simplestaking.features'
        ),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-wallets.spire.description'
      ),
      logo: 'spire.png',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-wallets.spire.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-wallets.temple.description'
      ),
      logo: 'temple.png',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-wallets.temple.features'),
      ],
      downloadLink: 'https://templewallet.com/download',
      category: EcosystemCategory.wallet,
    },
    {
      title: this.translateService.instant(
        'ecosystem-wallets.trust-wallet.title'
      ),
      description: this.translateService.instant(
        'ecosystem-wallets.trust-wallet.description'
      ),
      ...
      features: [
        this.translateService.instant(
          'ecosystem-wallets.trust-wallet.features'
        ),
      ],
    ...
    },
    {
      ...
      features: [
        this.translateService.instant('ecosystem-dapps.kolibri.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-dapps.openminter.description'
      ),
      logo: 'openminter.svg',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-dapps.openminter.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-dapps.tzbutton.description'
      ),
      logo: 'tzbutton.png',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-dapps.tzbutton.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-dapps.tzcolors.description'
      ),
      logo: 'tzcolors.png',
      socials: [
        {
      ...
      features: [
        this.translateService.instant('ecosystem-dapps.tzcolors.features'),
      ],
    ...
    {
      title: this.translateService.instant(
        'ecosystem-dapps.tezos-domains.title'
      ),
      description: this.translateService.instant(
        'ecosystem-dapps.tezos-domains.description'
      ),
      ...
      features: [
        this.translateService.instant('ecosystem-dapps.tezos-domains.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-dapps.tezex.description'
      ),
      logo: 'tezex.png',
      socials: [
        {
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-libraries.beacon.description'
      ),
      logo: 'beacon.svg',
      socials: [
        {
      ...
      platforms: [],
      features: [
        this.translateService.instant('ecosystem-libraries.beacon.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-libraries.ligo.description'
      ),
      logo: 'ligo.svg',
      socials: [
        {
      ...
      platforms: [],
      features: [
        this.translateService.instant('ecosystem-libraries.ligo.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-libraries.pytezos.description'
      ),
      logo: 'pytezos.png',
      socials: [
        {
      ...
      platforms: [],
      features: [
        this.translateService.instant('ecosystem-libraries.pytezos.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-libraries.smartpy.description'
      ),
      logo: 'smartpy.svg',
      socials: [
        {
      ...
      platforms: [],
      features: [
        this.translateService.instant('ecosystem-libraries.smartpy.features'),
      ],
    ...
    },
    {
      ...
      description: this.translateService.instant(
        'ecosystem-libraries.taquito.description'
      ),
      logo: 'taquito.png',
      socials: [
        {
      ...
      platforms: [],
      features: [
        this.translateService.instant('ecosystem-libraries.taquito.features'),
      ],
