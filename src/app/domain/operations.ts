...
export const operationErrorToMessage = (
  ...
  ErrorMap.set('michelson_v1.cannot_serialize_log', {
  ...
  ErrorMap.set('michelson_v1.cannot_serialize_storage', {
  ...
  ErrorMap.set('michelson_v1.unexpected_bigmap', {
  ...
  ErrorMap.set('michelson_v1.unexpected_contract', {
  ...
  ErrorMap.set('michelson_v1.unexpected_operation', {
  ...
  ErrorMap.set('micheline.parse_error.empty_expression', {
  ...
  ErrorMap.set('micheline.parse_error.odd_lengthed_bytes', {
  ...
  ErrorMap.set('micheline.parse_error.unclosed_token', {
  ...
  ErrorMap.set('micheline.parse_error.undefined_escape_sequence', {
  ...
  ErrorMap.set('micheline.parse_error.unexpected_character', {
  ...
  ErrorMap.set('micheline.parse_error.unexpected_token', {
  ...
  ErrorMap.set('micheline.parse_error.unterminated_comment', {
  ...
  ErrorMap.set('micheline.parse_error.unterminated_integer', {
  ...
  ErrorMap.set('client.alpha.actionDeserialisation', {
  ...
  ErrorMap.set('client.alpha.notEnoughSignatures', {
