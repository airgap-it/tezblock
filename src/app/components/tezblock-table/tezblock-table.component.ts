...
export const blockAndTxHashColumns = (
...
const satisfyData = (column: Column): Column =>
  column.data
    ...
    : {
        ...column,
        data: (item: any) => ({
          data: column.field ? item[column.field] : null,
        }),
      };
...
export class TezblockTableComponent implements OnInit {
  ...
  public basicTemplate: TemplateRef<any>;
  @ViewChild('amountTemplate', { static: true })
  public amountTemplate: TemplateRef<any>;
  @ViewChild('addressTemplate', { static: true })
  public addressTemplate: TemplateRef<any>;
  @ViewChild('percentageTemplate', { static: true })
  public percentageTemplate: TemplateRef<any>;
  @ViewChild('timestampTemplate', { static: true })
  public timestampTemplate: TemplateRef<any>;
  @ViewChild('blockTemplate', { static: true })
  public blockTemplate: TemplateRef<any>;
  @ViewChild('symbolTemplate', { static: true })
  public symbolTemplate: TemplateRef<any>;
  @ViewChild('hashTemplate', { static: true })
  ...
  public isExpanded(row: any): boolean {
    return (
      !!this.expandedRow &&
      this.expandedRows.includes(row[this.expandedRow.primaryKey])
    );
  }
