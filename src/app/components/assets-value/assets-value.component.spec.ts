    ...
    describe('value$', () => {
      ...
      describe('when assets are NOT empty', () => {
        ...
        it('then cryptoPricesService.getCurrencyConverterArgs is called with convertable symbol', () => {
          ...
          expect(cryptoPricesServiceMock.getCurrencyConverterArgs.calls.all()[0].args[0]).toEqual(asset1.symbol)
          expect(cryptoPricesServiceMock.getCurrencyConverterArgs.calls.all()[1].args[0]).toEqual(asset3.symbol)
        })
