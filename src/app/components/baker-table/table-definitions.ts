...
export const columns: {
  ...
  [OperationTypes.BakingRights]: (
    ...
    },
    {
      name: translateService.instant(
        'baker-table.baking-rights.number-of-bakings'
      ),
      field: 'bakingsCount',
      template: Template.basic,
    },
  ...
  [OperationTypes.EndorsingRights]: (
    ...
    {
      name: translateService.instant(
        'baker-table.endorsing-rights.number-of-endorsements'
      ),
    ...
    {
      name: translateService.instant(
        'baker-table.endorsing-rights.endorsement-rewards'
      ),
      field: 'endorsementRewards',
      template: Template.amount,
      data: (item: AggregatedEndorsingRights) => ({
        data: item.endorsementRewards,
        options,
      }),
    },
    {
  ...
  [OperationTypes.Rewards]: (
    ...
    },
    {
      ...
      data: (item: ExtendedTezosRewards) => ({
        data: Array.isArray(item.delegatedContracts)
          ? item.delegatedContracts.length
          : null,
      }),
      template: Template.basic,
    },
