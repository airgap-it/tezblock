...
export const increasePageOfBlocks = createAction(
  `[${featureName}] Increase Page Of Blocks`
);
export const sortBlocksByKind = createAction(
  `[${featureName}] Sort Blocks`,
...
export const increasePageOfTransactions = createAction(
  `[${featureName}] Increase Page Of Transactions`
);
...
export const loadDoubleBakings = createAction(
  `[${featureName}] Load Double Bakings`
);
...
export const loadDoubleBakingsFailed = createAction(
  `[${featureName}] Load Double Bakings Failed`,
  props<{ error: any }>()
);
export const increasePageOfDoubleBakings = createAction(
  `[${featureName}] Increase Page Of Double Bakings`
);
...
export const loadDoubleEndorsements = createAction(
  `[${featureName}] Load Double Endorsements`
);
...
export const loadDoubleEndorsementsFailed = createAction(
  `[${featureName}] Load Double Endorsements Failed`,
  props<{ error: any }>()
);
export const increasePageOfDoubleEndorsements = createAction(
  `[${featureName}] Increase Page Of Double Endorsements`
);
...
export const loadActiveBakers = createAction(
  `[${featureName}] Load Active Bakers`
);
export const loadActiveBakersSucceeded = createAction(
  `[${featureName}] Load Active Bakers Succeeded`,
  props<{ activeBakers: Baker[] }>()
);
export const loadActiveBakersFailed = createAction(
  `[${featureName}] Load Active Bakers Failed`,
  props<{ error: any }>()
);
export const increasePageOfActiveBakers = createAction(
  `[${featureName}] Increase Page Of Active Bakers`
);
...
export const loadTotalActiveBakers = createAction(
  `[${featureName}] Load Total Active Bakers`
);
...
export const loadTotalActiveBakersFailed = createAction(
  `[${featureName}] Load Total Active Bakers Failed`,
  props<{ error: any }>()
);
...
export const loadProposalsSucceeded = createAction(
  ...
  props<{ proposals: ProposalDto[] }>()
);
export const loadProposalsFailed = createAction(
  `[${featureName}] Load Proposals Failed`,
  props<{ error: any }>()
);
export const increasePageOfProposals = createAction(
  `[${featureName}] Increase Page Of Proposals`
);
...
export const loadVotesSucceeded = createAction(
  `[${featureName}] Load Votes Succeeded`,
  props<{ votes: any[] }>()
);
export const loadVotesFailed = createAction(
  `[${featureName}] Load Votes Failed`,
  props<{ error: any }>()
);
export const increasePageOfVotes = createAction(
  `[${featureName}] Increase Page Of Votes`
);
export const sortVotesByKind = createAction(
  `[${featureName}] Sort Votes`,
  props<{ orderBy: OrderBy }>()
);
...
export const increasePageOfEndorsements = createAction(
  `[${featureName}] Increase Page Of Endorsements`
);
...
export const loadTransactionsCountLast24h = createAction(
  `[${featureName}] Load Transactions Count Last 24h`
);
...
export const loadActivationsCountLast24h = createAction(
  `[${featureName}] Load Activations Count Last 24h`
);
...
export const loadActivations = createAction(
  `[${featureName}] Load Activations`
);
export const loadActivationsSucceeded = createAction(
  `[${featureName}] Load Activations Succeeded`,
  props<{ transactions: Transaction[] }>()
);
export const loadActivationsFailed = createAction(
  `[${featureName}] Load Activations Failed`,
  props<{ error: any }>()
);
export const increasePageOfActivations = createAction(
  `[${featureName}] Increase Page Of Activations`
);
...
export const loadOriginationsCountLast24h = createAction(
  `[${featureName}] Load Originations Count Last 24h`
);
...
export const loadOriginations = createAction(
  `[${featureName}] Load Originations`
);
export const loadOriginationsSucceeded = createAction(
  `[${featureName}] Load Originations Succeeded`,
  props<{ transactions: Transaction[] }>()
);
export const loadOriginationsFailed = createAction(
  `[${featureName}] Load Originations Failed`,
  props<{ error: any }>()
);
export const increasePageOfOriginations = createAction(
  `[${featureName}] Increase Page Of Originations`
);
...
export const loadDelegations = createAction(
  `[${featureName}] Load Delegations`
);
export const loadDelegationsSucceeded = createAction(
  `[${featureName}] Load Delegations Succeeded`,
  props<{ transactions: Transaction[] }>()
);
export const loadDelegationsFailed = createAction(
  `[${featureName}] Load Delegations Failed`,
  props<{ error: any }>()
);
export const increasePageOfDelegations = createAction(
  `[${featureName}] Increase Page Of Delegations`
);
...
export const loadTransactionsChartData = createAction(
  `[${featureName}] Load Transactions Chart Data`
);
...
export const loadTransactionsChartDataFailed = createAction(
  `[${featureName}] Load Transactions Chart Data Failed`,
  props<{ error: any }>()
);
export const loadTransactionsCountLastXd = createAction(
  `[${featureName}] Load Transactions Count Last 30d`
);
...
export const loadActivationsCountLastXd = createAction(
  `[${featureName}] Load Activations Count Last 30d`
);
...
export const loadOriginationsCountLastXd = createAction(
  `[${featureName}] Load Originations Count Last 30d`
);
...
export const loadContractsSucceeded = createAction(
  ...
  props<{ contracts: Account[] }>()
);
export const loadContractsFailed = createAction(
  `[${featureName}] Load Contracts Failed`,
  props<{ error: any }>()
);
export const increasePageOfContracts = createAction(
  `[${featureName}] Increase Page Of Contracts`
);
export const sortContracts = createAction(
  `[${featureName}] Sort Contracts`,
  props<{ orderBy: OrderBy }>()
);
