...
export const reducer = createReducer(
  ...
  on(
    actions.loadDoubleEndorsementsSucceeded,
    (state, { doubleEndorsements }) => ({
      ...state,
      doubleEndorsements: {
        ...state.doubleEndorsements,
  ...
  on(
    actions.loadTotalActiveBakersSucceeded,
    (state, { totalActiveBakers }) => ({
      ...state,
      activeBakers: {
        ...state.activeBakers,
        pagination: {
  ...
  on(
    actions.loadActivationsCountLast24hSucceeded,
    (state, { activationsCountLast24h }) => ({
      ...state,
      activationsCountLast24h,
    })
  ),
  on(
    actions.loadOriginationsCountLast24hSucceeded,
    (state, { originationsCountLast24h }) => ({
      ...state,
      originationsCountLast24h,
    })
  ),
  on(
    actions.loadTransactionsCountLast24hSucceeded,
    (state, { transactionsCountLast24h }) => ({
      ...state,
      transactionsCountLast24h,
    })
  ),
  on(
    actions.loadActivationsCountLastXdSucceeded,
    (state, { activationsCountLastXd }) => ({
      ...state,
      activationsCountLastXd,
    })
  ),
  on(
    actions.loadOriginationsCountLastXdSucceeded,
    (state, { originationsCountLastXd }) => ({
      ...state,
      originationsCountLastXd,
    })
  ),
  on(
    actions.loadTransactionsChartDataSucceeded,
    (state, { transactionsChartData }) => ({
      ...state,
  ...
  on(
    ...
    (state, { operationErrorsById, actionType }) => ({
      ...state,
      ...(actionType === actions.loadTransactionsSucceeded.type
        ...
        ? {
            activations: getTransactionsWithErrors(
              operationErrorsById,
              state.activations
            ),
          }
        ...
        ? {
            originations: getTransactionsWithErrors(
              operationErrorsById,
              state.originations
            ),
          }
        ...
        ? {
            delegations: getTransactionsWithErrors(
              operationErrorsById,
              state.delegations
            ),
          }
        ...
        ? {
            doubleEndorsements: getTransactionsWithErrors(
              operationErrorsById,
              state.doubleEndorsements
            ),
          }
        ...
        ? {
            endorsements: getTransactionsWithErrors(
              operationErrorsById,
              state.endorsements
            ),
          }
