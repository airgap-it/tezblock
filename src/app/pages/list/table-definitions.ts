...
export const columns: {
  ...
  [OperationTypes.Block]: (
    ...
    },
    {
      name: translateService.instant(
        'tezblock-table.block-list.transaction-volume'
      ),
      field: 'volume',
      template: Template.amount,
      data: (item: Block) => ({
        data: item.volume,
        options: { comparisonTimestamp: item.timestamp },
      }),
    },
    {
  ...
  [OperationTypes.Transaction]: (
    ...
    [
      ...
      {
        name: translateService.instant(
          'tezblock-table.transaction-list.amount'
        ),
        field: 'amount',
        template: Template.amount,
      ...
      {
        name: translateService.instant(
          'tezblock-table.transaction-list.parameters'
        ),
        field: 'parameters',
  ...
  [OperationTypes.Activation]: (
    ...
    [
      {
        name: translateService.instant(
          'tezblock-table.activation-list.account'
        ),
        field: 'pkh',
        width: '1',
        template: Template.address,
  ...
  [OperationTypes.Origination]: (
    ...
    [
      {
        name: translateService.instant(
          'tezblock-table.origination-list.new-account'
        ),
      ...
      {
        name: translateService.instant(
          'tezblock-table.origination-list.balance'
        ),
      ...
      {
        name: translateService.instant(
          'tezblock-table.origination-list.originator'
        ),
        field: 'source',
        width: '1',
        template: Template.address,
  ...
  [OperationTypes.Delegation]: (
    ...
    [
      {
        name: translateService.instant(
          'tezblock-table.delegation-list.delegator'
        ),
        field: 'source',
        width: '1',
        template: Template.address,
      ...
      {
        name: translateService.instant(
          'tezblock-table.delegation-list.gas-limit'
        ),
        field: 'gas_limit',
      },
    ].concat(<any>blockAndTxHashColumns(translateService)),
  ...
  [OperationTypes.Endorsement]: (
    ...
    {
      name: translateService.instant(
        'tezblock-table.endorsement-list.endorser'
      ),
      field: 'delegate',
      template: Template.address,
    },
  ...
  [OperationTypes.Ballot]: (options: {}, translateService?: TranslateService) =>
    [
      ...
      {
        name: translateService.instant(
          'tezblock-table.votes-list.voting-period'
        ),
        field: 'voting_period',
      },
      {
        name: translateService.instant(
          'tezblock-table.votes-list.number-of-votes'
        ),
        field: 'votes',
      },
      {
  ...
  [OperationTypes.DoubleBakingEvidenceOverview]: (
    ...
    [
      {
        name: translateService.instant(
          'tezblock-table.double-baking-list.baker'
        ),
        field: 'baker',
      ...
      {
        name: translateService.instant(
          'tezblock-table.double-baking-list.reward'
        ),
        field: 'reward',
      ...
      {
        name: translateService.instant(
          'tezblock-table.double-baking-list.offender'
        ),
        field: 'offender',
      ...
      {
        name: translateService.instant(
          'tezblock-table.double-baking-list.denounced-level'
        ),
      ...
      {
        name: translateService.instant(
          'tezblock-table.double-baking-list.lost-amount'
        ),
        field: 'lostAmount',

        template: Template.amount,
        data: (item: Transaction) => ({
          data: item.lostAmount,
          options: { ...options, comparisonTimestamp: item.timestamp },
        }),
      },
    ].concat(<any>blockAndTxHashColumns(translateService)),
  ...
  [OperationTypes.DoubleEndorsementEvidenceOverview]: (
    ...
    [
      {
        name: translateService.instant(
          'tezblock-table.double-endorsement-list.baker'
        ),
        field: 'baker',
      ...
      {
        name: translateService.instant(
          'tezblock-table.double-endorsement-list.age'
        ),
        field: 'timestamp',
        template: Template.timestamp,
        sortable: true,
      ...
      {
        name: translateService.instant(
          'tezblock-table.double-endorsement-list.reward'
        ),
        field: 'reward',
      ...
      {
        name: translateService.instant(
          'tezblock-table.double-endorsement-list.offender'
        ),
        field: 'offender',
        template: Template.address,
      },
      {
        name: translateService.instant(
          'tezblock-table.double-endorsement-list.denounced-level'
        ),
        field: 'denouncedLevel',
        template: Template.block,
      },
      {
        name: translateService.instant(
          'tezblock-table.double-endorsement-list.lost-amount'
        ),
        field: 'lostAmount',
        template: Template.amount,
        data: (item: Transaction) => ({
  ...
  [OperationTypes.ProposalOverview]: (
  ...
  ) => [
    {
      ...
      template: Template.hash,
      data: (item: Transaction) => ({
        data: item.proposal.replace(squareBrackets, ''),
        options: { kind: 'proposal' },
      }),
    },
    {
      name: translateService.instant(
        'tezblock-table.proposal-list.proposal-hash'
      ),
      field: 'proposal',
      data: (item: Transaction) => ({
        data: item.proposal.replace(squareBrackets, ''),
