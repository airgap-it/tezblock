...
export const loadTop25Accounts = createAction(`[${featureName}] Load Top 25 Accounts`)
...
export const loadTop25AccountsFailed = createAction(`[${featureName}] Load Top 25 Accounts Failed`, props<{ error: any }>())
