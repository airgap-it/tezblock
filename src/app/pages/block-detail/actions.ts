...
export const loadBlock = createAction(
  `[${featureName}] Load Block`,
  props<{ id: string }>()
);
export const loadBlockSucceeded = createAction(
  `[${featureName}] Load Block Succeeded`,
  props<{ block: Block }>()
);
export const loadBlockFailed = createAction(
  `[${featureName}] Load Block Failed`,
  props<{ error: any }>()
);

// TODO: remove block argument when it'll be in store
export const loadOperationsByKind = createAction(
  `[${featureName}] Load Operations By Kind`,
...
export const loadOperationsByKindFailed = createAction(
  `[${featureName}] Load Operations By Kind Failed`,
  props<{ error: any }>()
);
export const sortOperationsByKind = createAction(
...
export const loadOperationsCounts = createAction(
  `[${featureName}] Load Operations Counts`
);
export const loadOperationsCountsSucceeded = createAction(
  `[${featureName}] Load Operations Counts Succeeded`,
  props<{ counts: Count[] }>()
);
export const loadOperationsCountsFailed = createAction(
  `[${featureName}] Load Operations Counts Failed`,
  props<{ error: any }>()
);
