    ...
    describe('transactions$', () => {
      it('when kind is transfers then returns transfer operations', () => {
        ...
        testScheduler.run(({ expectObservable }) => {
          ...
          expectObservable(component.transactions$).toBe(
            expected,
            expectedValues
          );
        });
    ...
    describe('showFiatValue$', () => {
      it('when contract is falsy then return (contract)falsy value', () => {
        testScheduler.run(({ expectObservable }) => {
          ...
          expectObservable(component.showFiatValue$).toBe(
            expected,
            expectedValues
          );
        });
    ...
    describe('transactions24hCount$', () => {
      it('counts transactions number from last 24h', () => {
        ...
        testScheduler.run(({ expectObservable }) => {
          ...
          expectObservable(component.transactions24hCount$).toBe(
            expected,
            expectedValues
          );
        });
    ...
    describe('transactions24hVolume$', () => {
      it('sum transactions from last 24h amount', () => {
        ...
        testScheduler.run(({ expectObservable }) => {
          ...
          expectObservable(component.transactions24hVolume$).toBe(
            expected,
            expectedValues
          );
        });
    ...
    describe('getSocial', () => {
      ...
      it('findts contract social by condition', () => {
        ...
        testScheduler.run(({ expectObservable }) => {
          ...
          expectObservable(
            (<any>component).getSocial(
              (social: Social) => social.type === SocialType.medium
            )
